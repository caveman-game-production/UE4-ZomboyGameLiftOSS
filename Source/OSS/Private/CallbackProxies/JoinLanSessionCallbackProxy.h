...
#include "JoinLanSessionCallbackProxy.generated.h"

class APlayerController;

UCLASS(MinimalAPI)
class UJoinLanSessionCallbackProxy : public UOnlineBlueprintCallProxyBase
{
	...
	static UJoinLanSessionCallbackProxy* JoinLanSession(UObject* WorldContextObject, class APlayerController* PlayerController, const FBlueprintSessionResult& SearchResult);
